...
GIT_COMMIT="1e07d1542856d63f026448eb37e1276576d8381b"
SRC_URI="https://github.com/MusicPlayerDaemon/MPD/archive/${GIT_COMMIT}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/MPD-${GIT_COMMIT}"
