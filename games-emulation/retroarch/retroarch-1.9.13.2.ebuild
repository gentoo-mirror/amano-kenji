...
RDEPEND="
	...
	materialui? ( games-emulation/retroarch-assets )
	miniupnpc? ( net-libs/miniupnpc )
	openal? ( media-libs/openal )
	opengl? ( virtual/opengl )
	ozone? ( games-emulation/retroarch-assets )
	...
	rgui? ( games-emulation/retroarch-assets )
	...
	xmb? ( games-emulation/retroarch-assets )
