...
EGO_SUM=(
	...
	"github.com/99designs/keyring v1.1.7-0.20210324095724-d9b6b92e219f"
	"github.com/99designs/keyring v1.1.7-0.20210324095724-d9b6b92e219f/go.mod"
	"github.com/BurntSushi/toml v0.3.1/go.mod"
	"github.com/BurntSushi/xgb v0.0.0-20160522181843-27f122750802/go.mod"
	"github.com/ChainSafe/go-schnorrkel v0.0.0-20200405005733-88cbf1b4c40d"
	"github.com/ChainSafe/go-schnorrkel v0.0.0-20200405005733-88cbf1b4c40d/go.mod"
	...
	"github.com/confio/ics23/go v0.0.0-20200817220745-f173e6211efb/go.mod"
	"github.com/confio/ics23/go v0.6.3/go.mod"
	"github.com/confio/ics23/go v0.6.6"
	"github.com/confio/ics23/go v0.6.6/go.mod"
	...
	"github.com/cosmos/go-bip39 v0.0.0-20180819234021-555e2067c45d/go.mod"
	"github.com/cosmos/go-bip39 v1.0.0"
	"github.com/cosmos/go-bip39 v1.0.0/go.mod"
	"github.com/cosmos/iavl v0.15.0-rc3.0.20201009144442-230e9bdf52cd/go.mod"
	"github.com/cosmos/iavl v0.15.0-rc5/go.mod"
	"github.com/cosmos/iavl v0.15.3/go.mod"
	"github.com/cosmos/iavl v0.16.0"
	"github.com/cosmos/iavl v0.16.0/go.mod"
	"github.com/cosmos/ledger-cosmos-go v0.11.1"
	"github.com/cosmos/ledger-cosmos-go v0.11.1/go.mod"
	"github.com/cosmos/ledger-go v0.9.2"
	"github.com/cosmos/ledger-go v0.9.2/go.mod"
	...
	"github.com/dgraph-io/badger/v2 v2.2007.1/go.mod"
	"github.com/dgraph-io/badger/v2 v2.2007.2"
	"github.com/dgraph-io/badger/v2 v2.2007.2/go.mod"
	...
	"github.com/enigmampc/btcutil v1.0.3-0.20200723161021-e2fb6adb2a25/go.mod"
	...
	"github.com/gogo/gateway v1.1.0/go.mod"
	...
	"github.com/google/orderedcode v0.0.1/go.mod"
	...
	"github.com/grpc-ecosystem/go-grpc-middleware v1.2.1/go.mod"
	...
	"github.com/grpc-ecosystem/grpc-gateway v1.14.7/go.mod"
	"github.com/grpc-ecosystem/grpc-gateway v1.16.0"
	"github.com/grpc-ecosystem/grpc-gateway v1.16.0/go.mod"
	"github.com/gsterjov/go-libsecret v0.0.0-20161001094733-a6f4afe4910c"
	"github.com/gsterjov/go-libsecret v0.0.0-20161001094733-a6f4afe4910c/go.mod"
	"github.com/gtank/merlin v0.1.1-0.20191105220539-8318aed1a79f/go.mod"
	"github.com/gtank/merlin v0.1.1"
	"github.com/gtank/merlin v0.1.1/go.mod"
	"github.com/gtank/ristretto255 v0.1.2"
	"github.com/gtank/ristretto255 v0.1.2/go.mod"
	...
	"github.com/kkdai/bstream v1.0.0/go.mod"
	...
	"github.com/mimoo/StrobeGo v0.0.0-20181016162300-f8f6d4d2b643/go.mod"
	...
	"github.com/regen-network/cosmos-proto v0.3.1/go.mod"
	"github.com/regen-network/protobuf v1.3.3-alpha.regen.1"
	"github.com/regen-network/protobuf v1.3.3-alpha.regen.1/go.mod"
	...
	"github.com/sasha-s/go-deadlock v0.2.1-0.20190427202633-1595213edefa/go.mod"
	"github.com/sean-/seed v0.0.0-20170313163322-e2103e2c3529/go.mod"
	"github.com/sentinel-official/cosmos-sdk v0.42.6-sentinel"
	"github.com/sentinel-official/cosmos-sdk v0.42.6-sentinel/go.mod"
	"github.com/sentinel-official/hub v0.7.0"
	"github.com/sentinel-official/hub v0.7.0/go.mod"
	...
	"github.com/tendermint/btcd v0.1.1/go.mod"
	"github.com/tendermint/crypto v0.0.0-20191022145703-50d29ede1e15"
	"github.com/tendermint/crypto v0.0.0-20191022145703-50d29ede1e15/go.mod"
	"github.com/tendermint/go-amino v0.16.0"
	"github.com/tendermint/go-amino v0.16.0/go.mod"
	"github.com/tendermint/tendermint v0.34.0-rc4/go.mod"
	"github.com/tendermint/tendermint v0.34.0-rc6/go.mod"
	"github.com/tendermint/tendermint v0.34.0/go.mod"
	"github.com/tendermint/tendermint v0.34.10"
	"github.com/tendermint/tendermint v0.34.10/go.mod"
	"github.com/tendermint/tm-db v0.6.2/go.mod"
	"github.com/tendermint/tm-db v0.6.3/go.mod"
	"github.com/tendermint/tm-db v0.6.4"
	"github.com/tendermint/tm-db v0.6.4/go.mod"
	...
	"github.com/zondax/hid v0.9.0/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20200324203455-a04cca1dde73/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20201111145450-ac7456db90a6/go.mod"
	"google.golang.org/genproto v0.0.0-20201119123407-9b1e624d6bc4/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20210114201628-6edceaf6022f/go.mod"
